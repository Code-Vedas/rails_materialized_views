...
```bash
bundle exec rake smriti:bootstrap_demo\[1]
```
...
bundle exec rake smriti:validate_demo\[100]
...
```bash
bundle exec rake smriti:create_all\[true,--yes]
bundle exec rake smriti:refresh_all\[estimated,--yes]
bundle exec rake smriti:delete_all\[false,--yes]
```
...
- Engine README: [../smriti/README.md](../smriti/README.md)
