...
module MatViews
  module Services
    ...
    # - The public entrypoint is `#run` (defined in BaseService), which will call the
    ...
    class CheckMatviewExists < BaseService
      ...
      # Core execution step (invoked by BaseService#run).
      #
      # @api private
      #
      ...
      # Request initialization (invoked by BaseService#run).
      #
      # @api private
      #
