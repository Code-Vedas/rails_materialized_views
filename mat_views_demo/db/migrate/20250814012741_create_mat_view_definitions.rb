  ...
  def change
    create_table :mat_view_definitions do |t|
      t.string :name, null: false,
                      comment: 'The name of the materialised view'
      t.text :sql, null: false,
                   comment: 'The SQL query defining the materialised view'
      ...
      t.string :schedule_cron,
               comment: 'Cron schedule for automatic refresh of the materialised view'
