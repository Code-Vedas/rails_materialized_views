  ...
  def change
    create_table :mat_view_create_runs do |t|
      ...
      t.datetime :started_at,
                 comment: 'Timestamp when the creation operation started'
      t.datetime :finished_at,
                 comment: 'Timestamp when the creation operation finished'
      t.integer  :duration_ms,
                 comment: 'Duration of the creation operation in milliseconds'
      t.text     :error,
                 comment: 'Error message if the creation operation failed'
      t.jsonb    :meta, null: false, default: {},
                        comment: 'Additional metadata about the creation run, such as job ID or parameters'
