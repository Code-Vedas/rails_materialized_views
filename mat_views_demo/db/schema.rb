...
ActiveRecord::Schema[8.0].define(version: 2025_08_14_012801) do
  ...
  create_table "mat_view_definitions", force: :cascade do |t|
    ...
    t.integer "refresh_strategy", default: 0, null: false, comment: "Strategy for refreshing the materialized view. Options: regular, concurrent, swap"
