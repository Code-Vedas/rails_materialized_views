...
RSpec.describe 'Preferences', :feature do
  before { visit_dashboard }

  let(:lang_options) do
    Smriti::Engine.locale_code_mapping.values.sort
  end
  ...
  describe 'Change Language', :js do
    all_locales = Smriti::Engine.locale_code_mapping.to_a
    ...
    language_txt_before = I18n.t('smriti.settings.language', locale: lang_code_before)
    language_txt_after = I18n.t('smriti.settings.language', locale: lang_code_after)
