...
RSpec.describe Smriti::MatViewRun do
  let(:definition) { Smriti::MatViewDefinition.create!(name: 'sample', sql: 'SELECT 1') }
  ...
  describe 'scopes' do
    let(:definition_a) { Smriti::MatViewDefinition.create!(name: 'a_view', sql: 'SELECT 1') }
    let(:definition_b) { Smriti::MatViewDefinition.create!(name: 'b_view', sql: 'SELECT 1') }
    let!(:create_run) do
