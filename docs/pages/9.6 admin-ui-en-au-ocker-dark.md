---
title: "English (Australia ocker) Dark"
layout: page
parent: Admin UI
nav_order: 6
permalink: /admin-ui/en-AU-ocker/dark
---

# Admin UI: English (Australia ocker) Dark

This page showcases the Admin UI in English (Australia ocker) locale with Dark mode. The Admin UI provides a user-friendly interface to manage and monitor your materialized views. It allows you to create, refresh, and delete materialized views, as well as view their status and performance metrics.
